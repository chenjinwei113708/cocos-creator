            ...
            UI: {
                children: {
                    ...
                    banner: {
                        ...
                        children: {
                            logo: {
                                position: cc.v2(172.501, 83.913)
                            },
                            icon: {
                                position: cc.v2(-170.646, 85.768)
                            },
                            btn: {
                                position: cc.v2(-5.565, 83.913)
                            },
                        }
                    },
                    illustration: {
                        position: cc.v2(0, -466.389)
                    },
                    notification: {
