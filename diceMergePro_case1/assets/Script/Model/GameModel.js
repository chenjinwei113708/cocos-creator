        ...
        this.HorizontalConfig = {
            ...
            UI: {
                children: {
                    ...
                    // notification: {},
                    paypal: {
                        position: cc.v2(-237.732, 92.894),
                    },
                    banner: {
                        position: cc.v2(-246.805, -208.416),
                        children: {
                            icon: {
                                position: cc.v2(-163.182, -0.837)
                            },
                            slogan: {
                                position: cc.v2(-48.897, -8.574)
                            },
                            logo: {
                                width: 210,
                                height: 75,
                                position: cc.v2(10.828, 103.56)
                            },
                            btn: {
                                position: cc.v2(143.437, -3)
                            },
                            mtg: {
                                active: this.isMintegral,
                                position: cc.v2(20, 45.9)
                            }
                        }
                    },
                }
        ...
        this.VerticalConfig = {
            ...
            UI: {
                children: {
                    ...
                    // notification: {},
                    paypal: {
                        position: cc.v2(0, 305.219),
                    },
                    banner: {
                        position: cc.v2(0, -428),
                        children: {
                            icon: {
                                position: cc.v2(-220.037, -0.837)
                            },
                            slogan: {
                                position: cc.v2(-105.752, -8.574)
                            },
                            logo: {
                                width: 121,
                                height: 43,
                                position: cc.v2(189.35, 74.242)
                            },
                            btn: {
                                position: cc.v2(169.56, -3)
                            },
                            mtg: {
                                active: this.isMintegral,
                                position: cc.v2(0, 127.9)
                            }
                        }
                    },
                }
