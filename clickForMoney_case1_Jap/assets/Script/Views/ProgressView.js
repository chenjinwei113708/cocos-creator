...
cc.Class({
    ...
    onLoad () {
        this.pp1 = this.node.getChildByName('icon1');
        this.pp2 = this.node.getChildByName('icon2');
        this.pp3 = this.node.getChildByName('icon3');
        this.progressBar = this.node.getComponent(cc.ProgressBar);
        this.pps = [this.pp1, this.pp2, this.pp3];
