...
cc.Class({
    ...
    properties: {
        ...
        ppCoinSprite: cc.SpriteFrame, // pp金币图片
    },
    ...
    fallDownCoin (coin, isHit = false, direction = undefined, destPos = undefined) {
        ...
        let fallAction = cc.moveBy(1, 0, -700).easing(cc.easeIn(2.0));
    ...
    sendCoin () {
        ...
        // console.log(coin);
        this.gameInfo.isPPCoin && this.change2PPCoin(coin);
    ...
    change2PPCoin (coin) {
        // console.log(coin);
        coin.getChildByName('pic').getComponent(cc.Sprite).spriteFrame = this.ppCoinSprite;
        coin.getChildByName('pic').scale = 1.1;
    },
