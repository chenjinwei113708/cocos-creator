...
cc.Class({
    ...
    changePic (index, isPP = false) {
        let light = isPP ? this[`pp${index}`] : this[`light${index}`];
        let i = index;
    ...
    ppUp (index) {
        ...
        seven.runAction(cc.sequence(
            ...
            cc.callFunc(() => {
                if (index === 3) {
                    this.gameController.gameView.completePPs();
                }
            })
        ));
    }
