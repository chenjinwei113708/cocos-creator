    ...
    onTouchEnd (touch) {
        if (this.gameInfo.cellStatus === CELL_STATUS.IS_MOVE) {
            ...
            touchPos.y <= this.touchEnd.position.y + this.touchEnd.height/2) {
                ...
                this.endCard1.getComponent(cc.Sprite).spriteFrame = this.touchMove.getComponent(cc.Sprite).spriteFrame;
                this.endCard2.getComponent(cc.Sprite).spriteFrame = this.touchMove.getComponent(cc.Sprite).spriteFrame;
